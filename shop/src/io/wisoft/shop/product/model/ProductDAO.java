...
public class ProductDAO extends DBConnection {
    ...
    public boolean isAddProduct(ProductDTO dto) {
    ...
    public boolean isDelProduct(ProductDTO dto) {
        if (!isFindProductId(dto.getProductId())) return false;
    ...
    public boolean isSupplyProduct(ProductDTO dto) {
        if (!isFindProductId(dto.getProductId())) return false;
    ...
    public boolean isUpdatedProductUnitPrice(ProductDTO dto) {
        if (!isFindProductId(dto.getProductId())) return false;
