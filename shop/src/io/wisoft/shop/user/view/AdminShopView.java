        ...
        while (true) {
            ...
            switch (number) {
                case 1:
                    ...
                    break;
                case 2:
                    userController.delUser(inputInfo.inputUserId());
                    break;
                case 3:
                    productListView.printAllProduct();
                    break;
                case 4:
                    String updateMessage = productController.setProductUnitPrice(
                ...
                case 5:
                    ...
                    break;
                case 6:
                    String delMessage = productController.delProduct(inputInfo.inputProductId());
                    System.out.println(delMessage);
                    break;
                case 7:
                    String supplyMessage = productController.supplyProduct(
