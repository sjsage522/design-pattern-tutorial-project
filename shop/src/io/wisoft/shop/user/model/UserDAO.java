...
public class UserDAO extends DBConnection {
    ...
    //admin
    public boolean isDelUser(String id) {
    ...
    public void saveMoney(String userId, int payMoney) {
    ...
    public int getSavedMoney(String userId) {
    ...
    public boolean isUpdateUserRankId(String userId, int savedMoney) {
    ...
    public void updateUserRankId(UserDTO dto) {
    ...
    //login
    public boolean isExistUser(String inputId, String inputPw) {
