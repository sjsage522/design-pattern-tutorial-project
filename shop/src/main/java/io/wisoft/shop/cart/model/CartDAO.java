...
public class CartDAO extends DBConnection {
    ...
    public boolean isAddProductToCart(final CartDTO dto) {
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    CartDTO cartDTO = new CartDTO(user_id, product_id, product_name, total_price, total_count);
                    cartDTO.setCartId(
    ...
    public List<CartDTO> getCartListById(final String id) {
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    CartDTO cartDTO = new CartDTO(cartId, userId, productName, product_id, totalPrice, totalCount);
    ...
    public boolean isRemoveProductFromCart(final CartDTO cartDTO) {
    ...
    public boolean isBuyProductFromCart(final CartDTO cartDTO) {
        String userId = cartDTO.getUserId();

        String query = "SELECT product_name, product_id, SUM(total_price) AS total_price, " +
        ...
        try (Connection conn = getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    CartDTO dto = new CartDTO(productName, productId, totalPrice, totalCount);
                    tempList.add(dto);
                }
    ...
    public boolean isClearCart(final CartDTO cartDTO) {
        String userId = cartDTO.getUserId();
    ...
    private void updateProductCount(final String productId, final int totalCount) {
    ...
    private int getCurrentCount(final String productId) {
    ...
    private void addProduct(final CartDTO cartDTO) {
    ...
    private boolean isRemainProduct(final String productId, final int totalCount) {
        String query = "SELECT count FROM product WHERE product_id = ?";
